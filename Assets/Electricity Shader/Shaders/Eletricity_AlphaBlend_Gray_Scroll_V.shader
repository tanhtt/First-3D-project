...
////// Emissive:
                ...
                float3 node_15 = ((_MainColor.rgb*node_3.r)*(node_3.r*(tex2D(_DistortionTextureRchanel,TRANSFORM_TEX((i.uv0.rg+(node_8.g*_DistortionSpeed)*float2(0,1)), _DistortionTextureRchanel)).r*_DistortionPower)));
