...
Shader "Langvv/Eletricity_AlphaBlend_Color_Scroll_U" {
    Properties {
...
////// Emissive:
                ...
                float3 node_15 = ((_MainColor.rgb*node_3.rgb)*(node_3.rgb*(tex2D(_DistortionTextureRchanel,TRANSFORM_TEX((i.uv0.rg+(node_8.g*_DistortionSpeed)*float2(1,0)), _DistortionTextureRchanel)).r*_DistortionPower)));
